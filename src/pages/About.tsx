...
import { BookOpen, Heart, Eye, Quote } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-paper">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="font-serif text-4xl md:text-5xl font-bold mb-6">Rreth Nesh</h1>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        >
          <h2 className="font-serif text-3xl font-bold mb-6 text-center">Historia Jonë</h2>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-3xl font-bold mb-12 text-center">Rrugëtimi Ynë</h2>
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <h3 className="font-serif text-xl font-bold mb-3">Misioni Ynë</h3>
          ...
          >
            ...
            <h3 className="font-serif text-xl font-bold mb-3">Vizioni Ynë</h3>
            <p className="text-sm text-muted-foreground">
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="max-w-2xl mx-auto text-center"
          >
            <Quote className="h-10 w-10 mx-auto mb-6 opacity-60" />
            <blockquote className="font-serif text-2xl md:text-3xl font-medium italic mb-4 leading-relaxed">
              "Një dhomë pa libra është si një trup pa shpirt."
            </blockquote>
            <p className="opacity-70">— Marcus Tullius Cicero</p>
          </motion.div>
        </div>
      </section>
